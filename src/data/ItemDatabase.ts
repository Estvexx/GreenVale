...
export const ITEMS: Record<number, Item> = {
    ...
    10: {
        ...
        isSeed: true, cropKey: "grapes", growTime: 10000, harvestId: 20,
    ...
    11: {
        ...
        col: 1, row: 1,
        maxStack: 99, maxSlots: 10,
        isSeed: true, cropKey: "cucumber", growTime: 12000, harvestId: 21,
    ...
    12: {
        ...
        col: 2, row: 1,
        maxStack: 99, maxSlots: 10,
        isSeed: true, cropKey: "pepper", growTime: 15000, harvestId: 22,
    ...
    13: {
        ...
        col: 3, row: 1,
        maxStack: 99, maxSlots: 10,
        isSeed: true, cropKey: "greenbeans", growTime: 12000, harvestId: 23,
    ...
    14: {
        ...
        col: 4, row: 1,
        maxStack: 99, maxSlots: 10,
        isSeed: true, cropKey: "pineapple", growTime: 20000, harvestId: 24,
    ...
    15: {
        ...
        col: 5, row: 1,
        maxStack: 99, maxSlots: 10,
        isSeed: true, cropKey: "pumpkin", growTime: 10000, harvestId: 25,
