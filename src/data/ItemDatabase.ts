...
export const ITEMS: Record<number, Item> = {
    ...
    10: {
        ...
        isSeed: true, cropKey: "grapes", growTime: 15000, harvestId: 20,
        description: "Semente de uvas. Planta-a em terra preparada para produzir uvas.",
    ...
    11: {
        ...
        col: 1, row: 1,
        maxStack: 99, maxSlots: 10,
        isSeed: true, cropKey: "cucumber", growTime: 20000, harvestId: 21,
        description: "Semente de pepino. Uma boa escolha para uma colheita simples e rentável.",
    ...
    12: {
        ...
        col: 2, row: 1,
        maxStack: 99, maxSlots: 10,
        isSeed: true, cropKey: "pepper", growTime: 30000, harvestId: 22,
        description: "Semente de pimenta. Produz uma colheita picante com bom valor de venda.",
    ...
    13: {
        ...
        col: 3, row: 1,
        maxStack: 99, maxSlots: 10,
        isSeed: true, cropKey: "greenbeans", growTime: 25000, harvestId: 23,
        description: "Semente de vagem. Ideal para expandir a produção agrícola.",
    ...
    14: {
        ...
        col: 4, row: 1,
        maxStack: 99, maxSlots: 10,
        isSeed: true, cropKey: "pineapple", growTime: 45000, harvestId: 24,
        description: "Semente de ananás. Demora mais, mas pode render uma colheita valiosa.",
    ...
    15: {
        ...
        col: 5, row: 1,
        maxStack: 99, maxSlots: 10,
        isSeed: true, cropKey: "pumpkin", growTime: 12000, harvestId: 25,
        description: "Semente de feijão verde. Boa para manter uma produção constante.",
